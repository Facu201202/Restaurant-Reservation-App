...
router.post("/today", auth_1.validarAdminToken, user_controllers_1.reserveToday);
router.post("/updateReserve", auth_1.validarAdminToken, user_controllers_1.updateReserve);
router.get("/allUsers", auth_1.validarAdminToken, user_controllers_1.getUsers);
router.post("/modifyUser", auth_1.validarAdminToken, user_controllers_1.modifyUser);
